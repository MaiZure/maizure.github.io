/*  SHP/SHR/EXP/HEL/H2 to BMP file converter designed for Traffic Department 2192
*	argv[1] points to Image data file
*
* Five issues:
...
int main(int argc, char* argv[])
{
	...
	IMAGE_WIDTH = 32;
	IMAGE_HEIGHT = 32;
	/*IMAGE_WIDTH = ((argv[1])[FILENAME_LEN-1] == '4') ? 40 : 32;  /* Pre-determined widths */
	IMAGE_COUNT = FILE_SIZE / (IMAGE_WIDTH*IMAGE_HEIGHT); 		/* Number of frames */
